...
class Function
{
    ...
    //function 8, -15.0 <= x <= -5.0, -3.0 <= y <= 3.0
    //xm = -10.0, ym = 1.0, fm = 0.0
    private static double bukinN6(double x, double y)
    {
        return 100 * sqrt(abs(y - 0.01 * x * x)) + 0.01 * abs(x + 10);
    }

    //function 9, -5.0 <= x,y <= 5.0
    //xm1 =  3.0     , ym1 =  2.0     , fm = 0
    //xm2 = -2.805118, ym2 =  3.131312, fm = 0
    //xm3 = -3.779310, ym3 = -3.283186, fm = 0
    //xm4 =  3.584428, ym4 = -1.848126, fm = 0
    private static double himmelblaus(double x, double y)
    {
        return pow((x * x + y - 11), 2) + pow((x + y * y - 7), 2);
    }

    //function 10, -10.0 <= x,y <= 10.0
    //xm = +-1.34941, ym = +-1.34941, fm = -2.06261
    private static double cross_in_tray(double x, double y)
    {
